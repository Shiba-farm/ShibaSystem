...
{
    public class BlendSimpleInspector : ShaderGUI
    {
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            materialEditor.TexturePropertyTwoLines(new GUIContent("Layer0 Normal Texture"), layer0Normal, layer0NormalIntensity, new GUIContent("Layer0 Normal Intensity"), null);
            ...
            GUI.contentColor = new Color(1, 0.3f, 0.3f);
            ...
            materialEditor.TexturePropertyTwoLines(new GUIContent("Layer1 Normal Texture"), layer1Normal, layer1NormalIntensity, new GUIContent("Layer1 Normal Intensity"), null);
            ...
            materialEditor.TexturePropertyTwoLines(new GUIContent("Layer2 Normal Texture"), layer2Normal, layer2NormalIntensity, new GUIContent("Layer2 Normal Intensity"), null);
            ...
            materialEditor.TexturePropertyTwoLines(new GUIContent("Layer3 Normal Texture"), layer3Normal, layer3NormalIntensity, new GUIContent("Layer2 Normal Intensity"), null);
