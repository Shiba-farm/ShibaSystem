...
public class BedRestAdvanced : MonoBehaviour
{
    ...
    [Tooltip("��ҵ�ͧ����¡ Text ����Ѻ�ʴ���Ŵ�ǹ� �������ǹ�� (���������)")]
    public TextMeshProUGUI cooldownText;

    [Header("Sleep UI (���͡���ҵ��)")]
    public CanvasGroup sleepPanel;          // Panel UI ���͡����
    public Slider hourSlider;               // 0..23
    public Slider minuteSlider;             // 0..59
    public int minuteStep = 5;              // ��Ѻ���С��ҷ� (1 = �ء�ҷ�)
    public TextMeshProUGUI timePreview;     // �ʴ��� hh:mm
    public Button confirmButton;
    public Button cancelButton;

    [Header("Fade")]
    public CanvasGroup fadeCanvas;          // �ʹ�
