...
public class CraftingMainUI : MonoBehaviour
{
    ...
    private void HandleRecipeLearned(string recipeName)
    {
        // TODO: แสดง notification "เรียนสูตรใหม่" ให้ผู้เล่นเห็น
        Debug.Log($"[CraftingMainUI] เรียนสูตรใหม่: {recipeName}");
        RequestData(); // รีเฟรช recipe list ทันที
    }
