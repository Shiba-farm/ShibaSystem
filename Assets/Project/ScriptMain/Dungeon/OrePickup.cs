...
public class OrePickup : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // fallback: หา Player เองถ้าไม่ได้รับมา — ใช้ LocalPlayerUtil กันจับผู้เล่นคนอื่นผิดตัวตอน Multiplayer
        if (targetTransform == null)
        {
            targetTransform = LocalPlayerUtil.GetLocalPlayerTransform();
        }
