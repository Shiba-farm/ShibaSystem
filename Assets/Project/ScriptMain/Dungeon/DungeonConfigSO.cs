...
namespace MyGame.Dungeon
{
    ...
    public class DungeonConfigSO : ScriptableObject
    {
        ...
        public int baseOreCount    = 25;
        public int baseEnemyCount  = 3;
        public int baseRockCount   = 8;

        [Header("Scaling ทุก 10 ชั้น")]
        public int oreCountPerTenFloors    = 5;
        ...
        public int maxOreCount   = 60;
        public int maxRockCount  = 30;

        [Header("Ore Clustering")]
        [Tooltip("จำนวนแร่ขั้นต่ำต่อ 1 cluster (แนะนำ 2-3)")]
        [Min(1)]
        public int oreClusterMin = 2;
        [Tooltip("จำนวนแร่สูงสุดต่อ 1 cluster (แนะนำ 4-6 สำหรับ Stardew-style)")]
        [Min(1)]
        public int oreClusterMax = 5;
